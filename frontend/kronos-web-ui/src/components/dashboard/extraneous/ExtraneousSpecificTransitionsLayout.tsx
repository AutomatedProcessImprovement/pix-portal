...
const ExtraneousSpecificTransitionsLayout: React.FC<ExtraneousSpecificTransitionsLayoutProps> = ({
  jobId,
    ...
    >
      ...
      >
        ...
        <Grid item xs={12}>
          ...
          <TransitionsBarChart data={barChartDataByResource} selectedWTType={"extraneous"} />
        </Grid>
      </Grid>
    </Box>
  );
