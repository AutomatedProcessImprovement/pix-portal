...
const PrioritizationSpecificTransitionsLayout: React.FC<PrioritizationSpecificTransitionsLayoutProps> = ({
  ...
  const barChartDataByResource = useFetchData(
    ...
    >
      ...
      >
        ...
        <Grid item xs={12}>
          ...
          <TransitionsBarChart data={barChartData} selectedWTType={"prioritization"} />
        </Grid>
        <Grid item xs={12}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Typography variant="h6" style={{ marginRight: "8px" }}>
          ...
          <ResourcesBarChart
            data={activityResourceWT}
            selectedWt="prioritization"
            selectedActivity={destinationActivity}
          />
        </Grid>
        <Grid item xs={12}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <Tooltip
              title={
                <span style={{ fontSize: "1rem" }}>
                  Waiting time between a pair of resources executing activities of the selected transition, categorized
                  by the causes of waiting.
                </span>
              }
            >
              <IconButton size="small" aria-label="info about waiting time causes">
          ...
          <TransitionsBarChart data={barChartDataByResource} selectedWTType={"prioritization"} />
        </Grid>
      </Grid>
    </Box>
  );
