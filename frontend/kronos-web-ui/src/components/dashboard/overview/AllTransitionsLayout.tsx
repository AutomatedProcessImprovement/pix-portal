                ...
                <Tooltip
                  title={
                    <Typography variant="body2">
                      ...
                      <ol>
                        <li>
                          <strong>Batching</strong> – when an activity instance waits for another activity instance to
                          be enabled in order to be processed together as a batch.
                        </li>
                        <li>
                          <strong>Resource contention</strong> – when an activity instance waits to be processed by an
                          assigned resource that is busy processing other activity instances, following a
                          first-in-first-out (FIFO) order.
                        </li>
                        <li>
                          <strong>Prioritization</strong> – when the assigned resource is busy with an activity instance
                          that was prioritized over the waiting one (not executed in the FIFO order).
                        </li>
                        <li>
                          <strong>Resource unavailability</strong> – when the assigned resource is unavailable (off
                          duty) due to their working schedules.
                        </li>
                        <li>
                          <strong>Extraneous factors</strong> – waiting times caused by external effects that cannot be
                          identified from the event log, e.g., the resource is working on another process, fatigue
                          effects, or context switches.
                        </li>
                      </ol>
                    </Typography>
                  }
        ...
        <Grid item xs={12}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            ...
            <FormControl variant="outlined">
              <InputLabel>Data Mode</InputLabel>
              <Select value={dataMode} onChange={(e) => setDataMode(e.target.value)} label="Data Mode">
        ...
        <Grid item xs={12}>
          <div style={{ display: "flex", alignItems: "center", marginBottom: "8px" }}>
            ...
            <Tooltip
              title={
                <span style={{ fontSize: "1rem" }}>
                  Eliminating waiting times in these transitions has the potential to yield the most significant
                  improvement in CTE. Distribution per cause reveals the improvement opportunities in each transition
                  and indicates which opportunities could offer the highest CTE improvement.
                </span>
              }
            >
