...
const ContentionAllTransitionsLayout: React.FC<{ jobId: string }> = ({ jobId }) => {
    ...
    >
      ...
      >
        ...
        <Grid item xs={12}>
          ...
          <WaitingTimeframe data={timeFrameData} wtType={"contention"} />
        </Grid>
        <Grid item xs={12}>
        ...
        <Grid item xs={12}>
          ...
          <TransitionsBarChart data={activityWT} selectedWTType={"contention"} />
        </Grid>
        <Grid item xs={12}>
          <ResourcesBarChart data={activityResourceWT} selectedWt="contention" />
        </Grid>
      </Grid>
    </Box>
  );
