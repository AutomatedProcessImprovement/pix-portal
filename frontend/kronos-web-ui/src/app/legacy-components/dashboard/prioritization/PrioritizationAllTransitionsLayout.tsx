...
const PrioritizationAllTransitionsLayout: React.FC<{ jobId: string }> = ({ jobId }) => {
      ...
      >
        <Grid item xs={4}>
          ...
          >
            ...
            <div>
              {overviewData.distinct_cases} / {overviewData.cases}
            </div>
        ...
        <Grid item xs={12}>
          ...
          <WaitingTimeframe data={timeFrameData} wtType={"prioritization"} />
        </Grid>
        <Grid item xs={12}>
          ...
          <TransitionsBarChart data={transitionsData} selectedWTType={"prioritization"} />
        </Grid>
        <Grid item xs={12}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <Tooltip
                title={
                  <span style={{ fontSize: "1rem" }}>
                    The sum of all transitions (waiting times) incoming in each activity. Indicates which activities
                    could be bottlenecks in the process.
                  </span>
                }
              >
                <IconButton size="small" aria-label="info about waiting time causes">
            ...
            <FormControl variant="outlined">
              <InputLabel>Data Mode</InputLabel>
              <Select value={dataMode2} onChange={(e) => setDataMode2(e.target.value)} label="Data Mode">
                <MenuItem value={"Average"}>Average by activity</MenuItem>
                <MenuItem value={"Total"}>Total</MenuItem>
              </Select>
            </FormControl>
          </div>
          <TransitionsBarChart data={activityWT} selectedWTType={"prioritization"} />
        </Grid>
        <Grid item xs={12}>
...
export default PrioritizationAllTransitionsLayout;
